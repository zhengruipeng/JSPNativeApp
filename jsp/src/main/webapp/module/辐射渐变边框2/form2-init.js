    ...
    * */
    ...
    initControls(width,height){
        ...
        this.data.forEach(data => {
            let key,value,startX,startY,endX,endY;
            try{
                [key,value,[startX,startY],[endX,endY]] = data;
            }catch (e){
            ...
            fieldsetEle.style.gridColumn = `${startX} / ${endX}`;
            fieldsetEle.style.gridRow = `${startY} / ${endY}`;
